...
enum class TelemetryEvents {
  ...
  COMPARE_INDEX_SIZE, COMPARE_INDEX_IDS,
  PRISONER_UPDATED, PRISONER_UPDATED_OS_NO_CHANGE, PRISONER_UPDATED_DB_NO_CHANGE, PRISONER_UPDATED_NO_DIFFERENCES,
  PRISONER_REMOVED, PRISONER_CREATED, PRISONER_NOT_FOUND, MISSING_OFFENDER_ID_DISPLAY,
  DIFFERENCE_REPORTED, DIFFERENCE_MISSING, EVENTS_UNKNOWN_MOVEMENT, EVENTS_SEND_FAILURE,
}
