...
import uk.gov.justice.digital.hmpps.prisonersearch.search.services.KeywordService
...
class PrisonerKeywordResource(private val keywordService: KeywordService) {
  ...
  ): Page<Prisoner> = keywordService.findByKeyword(keywordRequest, responseFields)
}
