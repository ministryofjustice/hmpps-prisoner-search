...
data class Address(
  @Schema(description = "The full address on a single line.  No fixed address records will have the fullAddress set to 'No fixed address'.", example = "1 Main Street, Crookes, Sheffield, South Yorkshire, S10 1BP, England")
  ...
  @Schema(description = "No fixed address. This address record is only ever returned if it is also the primary address, otherwise it is ignored.", example = "true")
